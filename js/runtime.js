...
function createtime() {
    ...
    var e = new Date("12/17/2023 00:00:00"),
        t = Math.trunc(234e8 + (now - e) / 1e3 * 17),
        a = (t / 1496e5).toFixed(6),
        o = new Date("12/10/2023 00:00:00"),
    ...
    c = ` <div style="font-size:13px;font-weight:bold">本站苟活了 ${r} 天 ${s} 小时 ${l} 分 ${b} 秒 
    <i id="heartbeat" class='fas fa-heartbeat'></i> 
    </div>`;
   /* document.getElementById("workboard") && */
        (document.getElementById("workboard").innerHTML = c) 
     document.getElementById("workboard").className = "workboard" 
}
